...
%The Ezuino programming language uses both function call and declaration from the C programming language. The Ezuino programming language uses a more modern style of function usage and declaration where the C programming language use void main(), the Ezuino programming language uses func main(), like most modern programming languages.  
\begin{figure}[H]
\centering
