...
\begin{figure}[H]
\centering
\frame{\includegraphics[scale=0.80]{figures/language_features/Example1.PNG}}
...
\begin{figure}[H]
\centering
\frame{\includegraphics[scale=0.80]{figures/language_features/Example2.PNG}}
\caption{Program structure where global scope work as main}
\label{lf10}
\end{figure}
...
\begin{figure}[H]
\centering
\frame{\includegraphics[scale=0.80]{figures/language_features/Example3.PNG}}
